...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_MaxHealth = { "MaxHealth", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AShooterAntCharacter, MaxHealth), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxHealth_MetaData), NewProp_MaxHealth_MetaData) };
void Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_isAlive_SetBit(void* Obj)
{
	((AShooterAntCharacter*)Obj)->isAlive = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_isAlive = { "isAlive", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AShooterAntCharacter), &Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_isAlive_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_isAlive_MetaData), NewProp_isAlive_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AShooterAntCharacter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_MaxHealth,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AShooterAntCharacter_Statics::NewProp_isAlive,
};
...
struct Z_CompiledInDeferFile_FID_Users_antho_Desktop_Unreal_Engine_Projects_ShooterAnt_Source_ShooterAnt_ShooterAntCharacter_h__Script_ShooterAnt_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterAntCharacter, AShooterAntCharacter::StaticClass, TEXT("AShooterAntCharacter"), &Z_Registration_Info_UClass_AShooterAntCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterAntCharacter), 1621285898U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_antho_Desktop_Unreal_Engine_Projects_ShooterAnt_Source_ShooterAnt_ShooterAntCharacter_h__Script_ShooterAnt_2334279148(TEXT("/Script/ShooterAnt"),
